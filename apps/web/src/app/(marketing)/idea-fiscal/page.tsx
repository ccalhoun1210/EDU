        ...
        <section className={styles.pageHero}>
          <div className={styles.container}>
            ...
            <h1 className={styles.pageTitle}>
              The four requirements, each with its citation and its arithmetic.
            </h1>
        ...
        >
          <div className={styles.prose}>
            <p>
              ...
              lawfully reduce what you were required to spend —{' '}
              <strong>if you can evidence it inside the window.</strong>
            </p>
            <p>
            ...
            <div className={styles.ctaInner}>
              <div>
                ...
                <p className={styles.ctaSub}>
                  Every rule carries its citation, its authority, and the dates it was in force.
                  Open the registry, or bring your own numbers and we will run them.
                </p>
              </div>
