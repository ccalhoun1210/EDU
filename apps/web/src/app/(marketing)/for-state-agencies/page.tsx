        ...
        <section className={styles.pageHero}>
          <div className={styles.container}>
            ...
            <h1 className={styles.pageTitle}>
              Monitor every LEA from one engine — not a different spreadsheet each.
            </h1>
            <p className={styles.pageIntro}>
              A different product for a different buyer. State education agencies monitor IDEA
              fiscal compliance across every LEA; the same rule engine that gives a district its
