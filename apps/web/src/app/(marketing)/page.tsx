              ...
              <tbody>
                {COVERAGE.map((c) => (
                  <tr key={c.name}>
                    ...
                    <td>
                      <span
                        className={`${styles.statusBadge} ${c.live ? styles.stPass : styles.stNa}`}
                      >
              ...
              <div className={styles.ctaInner}>
                <div>
                  <h2 className={styles.ctaTitle}>
                    See a determination you could hand to a monitor.
                  </h2>
                  <p className={styles.ctaSub}>
                    Bring a program you oversee and we will walk it through the IDEA Part B rule
                    pack live — citations, statuses, and the arithmetic behind each result.
                  </p>
                </div>
                <div className={styles.ctaActions}>
                  ...
                  <p className={styles.ctaFine}>
                    State rules differ. The second conversation is for SEA-adjacent buyers who need
                    to know we can model theirs.
                  </p>
                </div>
              </div>
            </div>
