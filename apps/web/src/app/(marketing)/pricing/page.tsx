        ...
        >
          <div className={styles.callout}>
            ...
            <p>
              ...
              supplement, not supplant (<code>34 CFR 300.202</code>). Permissive use covers
              technology for IEP <em>case-management</em> recordkeeping (
              <code>34 CFR 300.208(c)</code>) — a plausible fit for the programmatic module later, a
              stretch for the fiscal module today.
            </p>
            <p>
              ...
              Bring your federal-programs director and your SEA fiscal contact into the first call
              and we&apos;ll work the funding source through together.
            </p>
          </div>
        </LedgerSection>
            ...
            <div className={sales.ctaInner}>
              <div>
                ...
                <p className={sales.ctaSub}>
                  ...
                  you&apos;re ready, we&apos;ll quote against your state&apos;s actual allocation
                  table and work through the funding source.
                </p>
              </div>
