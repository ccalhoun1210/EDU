...
const STANDARDS = [
  {
    term: 'SOC 2 Type II',
    status: 'In progress',
    note: 'Controls implemented; formal audit scheduled. We will publish the report when it exists — not a badge before it does.',
  },
  {
    term: 'Penetration testing',
    status: 'Planned',
    note: 'Independent third-party test planned ahead of first production district.',
  },
  {
    term: 'Incident response',
    status: 'In place',
    note: 'Documented breach-notification process aligned to state and FERPA timelines.',
  },
  {
    term: 'Data retention & deletion',
    status: 'In place',
    note: 'District data returned or destroyed on contract termination, per the DPA.',
  },
];
