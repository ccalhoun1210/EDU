...
const GUIDES = [
  ...
  { name: 'The subsequent-years rule: why a failed year does not reset your baseline', meta: 'OSEP' },
  { name: 'Excess cost: the calculation, worked', meta: '§ 300.16' },
  { name: 'The 50% adjustment under § 300.205 — and why CEIS eats into it', meta: '§ 300.205 / § 300.226' },
];

const CALENDAR = [
  { when: 'Feb – Apr', doing: 'Building next year’s budget', publish: 'Eligibility standard; budgeting to pass MOE' },
  { when: 'Jun – Jul', doing: 'Fiscal close; certifications', publish: 'Closing the year cleanly; what to document now' },
  { when: 'Sep – Oct', doing: 'Claim amendments close; preliminary reviews', publish: 'The exceptions window; evidence checklists' },
  { when: 'Feb – Mar', doing: 'Final determinations and penalty notices', publish: 'What to do if you received one; corrective action' },
];
      ...
      <main id="main">
        <section className={styles.pageHero}>
          <div className={styles.container}>
            ...
            <h1 className={styles.pageTitle}>The IDEA fiscal reference your state agency writes badly.</h1>
